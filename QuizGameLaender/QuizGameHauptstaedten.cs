...
{
    public partial class QuizGameHauptstaedten : Form, QuizGameInterface
    {
        ...
        Land richtig = null;
        int punkteEnde = 0;
        public QuizGameHauptstaedten(Login login)
        {
            Login = login;
            InitializeComponent();
        ...
        private void QuizGameHauptstaedten_Load(object sender, EventArgs e)
        {
            Datenbank.conn.Open();
        ...
        public void fragen()
        {
            ...
            for (int i = 0; i < 4; ++i)
            {
                buttonsAntwort[i].Text = auswahl[i].Hauptstadt;
        ...
        private void checkAntwortEvent(object sender, EventArgs e)
        {
            ...
            if (antwort != richtig)
            {
                MessageBox.Show("Die Antwort war leider falsch. Richtig war " + richtig.Hauptstadt + ".");
            }
            zaehler--;
            fragen();
            //Spielende
            if (zaehler == 0)
            {
                ...
                string spielart = "Hauptstädtenspiel";
